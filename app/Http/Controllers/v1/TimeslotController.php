...
class TimeslotController extends Controller
{
   public function save(Request $request){
        ...
        $matchThese = ['uid' => $request->uid, 'week_id' => $request->week_id, 'start_time' => $request->start_time, 'end_time' => $request->end_time];
    ...
    public function getSlots(Request $request){
        ...
        if($data){
            $availableSlots =Timeslots::select('start_time','end_time')->where($matchThese)->get();
        }
    ...
    public function getSlotsByForBookings(Request $request){
        ...
        $matchThese = ['uid' => $request->uid, 'week_id' => $request->week_id];
        $data = Timeslots::select('id','uid','week_id','slots','status')->where($matchThese)->first();
